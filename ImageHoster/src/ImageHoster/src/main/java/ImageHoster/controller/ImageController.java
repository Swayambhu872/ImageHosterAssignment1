...
public class ImageController {
    ...
    public String showImage(Model model, @PathVariable("imageId") int imageId, @PathVariable("title") String title) {
    ...
    // This method is called to check if the loggedin user is the owner of the image being edited or deleted
